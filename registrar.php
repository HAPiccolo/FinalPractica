...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt->execute([$nombre_apellido, $dni, $edad, $sexo, $telefono, $obra_social, 
                        $fecha_accidente, $ubicacion, $tipo_accidente, $vehiculo_involucrado, 
                        $uso_casco_cinturon, $estado_via, $factores_riesgo, $lugar_atencion, 
                        $traslado_ambulancia, $tiempo_atencion, $region_afectada, $tipo_lesion, 
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="ubicacion" name="ubicacion" placeholder="Dirección exacta, ciudad, provincia" required>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_accidente[]" value="Caída de altura" id="caida_altura">
                                    <label class="form-check-label" for="caida_altura">Caída de altura</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_accidente[]" value="Accidente de tránsito" id="transito">
                                    <label class="form-check-label" for="transito">Accidente de tránsito</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_accidente[]" value="Accidente laboral" id="laboral">
                                    <label class="form-check-label" for="laboral">Accidente laboral</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_accidente[]" value="Doméstico" id="domestico">
                                    <label class="form-check-label" for="domestico">Doméstico</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_accidente[]" value="Deportivo" id="deportivo">
                                    <label class="form-check-label" for="deportivo">Deportivo</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_accidente[]" value="Otro" id="otro_accidente">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="vehiculo_involucrado[]" value="Peatón" id="peaton">
                                    <label class="form-check-label" for="peaton">Peatón</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="vehiculo_involucrado[]" value="Bicicleta" id="bicicleta">
                                    <label class="form-check-label" for="bicicleta">Bicicleta</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="vehiculo_involucrado[]" value="Moto" id="moto">
                                    <label class="form-check-label" for="moto">Moto</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="vehiculo_involucrado[]" value="Auto" id="auto">
                                    <label class="form-check-label" for="auto">Auto</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="vehiculo_involucrado[]" value="Camión" id="camion">
                                    <label class="form-check-label" for="camion">Camión</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="vehiculo_involucrado[]" value="Transporte público" id="transporte_publico">
                                    <label class="form-check-label" for="transporte_publico">Transporte público</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="vehiculo_involucrado[]" value="Otro" id="otro_vehiculo">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="uso_casco_cinturon" name="uso_casco_cinturon">
                                <option value="">Seleccionar...</option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="estado_via" name="estado_via" placeholder="seca, mojada, en mal estado, etc.">
                        </div>
                    </div>
                    
                    <div class="mb-3">
                        <label for="factores_riesgo" class="form-label">Factores de riesgo</label>
                        <textarea class="form-control" id="factores_riesgo" name="factores_riesgo" rows="2" placeholder="alcohol, velocidad, trabajo sin protección, etc."></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="lugar_atencion" name="lugar_atencion">
                                <option value="">Seleccionar...</option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="traslado_ambulancia" name="traslado_ambulancia">
                                <option value="">Seleccionar...</option>
                                <option value="Sí">Sí</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tiempo_atencion" name="tiempo_atencion" placeholder="Ej: 30 minutos, 1 hora, etc.">
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="region_afectada" name="region_afectada">
                                <option value="">Seleccionar...</option>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_lesion[]" value="Fractura" id="fractura">
                                    <label class="form-check-label" for="fractura">Fractura</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_lesion[]" value="Esguince" id="esguince">
                                    <label class="form-check-label" for="esguince">Esguince</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_lesion[]" value="Luxación" id="luxacion">
                                    <label class="form-check-label" for="luxacion">Luxación</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_lesion[]" value="Contusión" id="contusion">
                                    <label class="form-check-label" for="contusion">Contusión</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_lesion[]" value="Herida" id="herida">
                                    <label class="form-check-label" for="herida">Herida</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_lesion[]" value="Politraumatismo" id="politraumatismo">
                                    <label class="form-check-label" for="politraumatismo">Politraumatismo</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tipo_lesion[]" value="Otro" id="otro_lesion">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="tratamiento_inicial" name="tratamiento_inicial" rows="3" placeholder="Inmovilización, férula, cirugía inmediata, observación, internación, alta médica, etc."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="evolucion_seguimiento" name="evolucion_seguimiento" rows="3" placeholder="Internación (días), complicaciones, alta definitiva, etc."></textarea>
                    </div>
                </div>
            </div>
